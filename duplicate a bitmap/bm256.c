...
#define PIXEL_OFFSET            1078
#define NO_COMPRESSION          0
#define EXPECTED_BITS_PER_PIXEL 8

bm256_status_t bm256_create(const char* name, bm256_t* obj) {
...
bm256_status_t bm256_dispose(bm256_t* obj) {
    free(obj -> contents);  
    obj -> contents = NULL;
    obj -> pixels = NULL;
    return OK;
